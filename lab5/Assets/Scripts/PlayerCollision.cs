...
public class PlayerCollision : MonoBehaviour
{
    ...
    [SerializeField] private AudioSource dieforyou;
    ...
    private void OnTriggerEnter2D(Collider2D col)
    {
        ...
        {
            playerController.Jump(jumpPad.GetJumpPadForce(), 
            jumpPad.GetAdditionalSleepJumpTime());
