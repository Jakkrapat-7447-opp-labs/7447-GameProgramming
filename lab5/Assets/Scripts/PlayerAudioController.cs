...
public class PlayerAudioController : MonoBehaviour
{
    ...
    public void PlayJumpSound() 
    {
        ...
        (jumpAudioClips.GetAudioClip(), 0.5f);
    }
    public void PlayWalkSound()  
    {
        audioSource.PlayOneShot
        (walkAudioClips.GetAudioClip(), 0.5f);
    }

    public void PlayFallSound()
    {
        audioSource.PlayOneShot
        (fallAudioClips.GetAudioClip(), 0.5f);
    }
    
    public void PlayJumppadSound() 
    {
       audioSource.PlayOneShot
       (JumppadAudioClips.GetAudioClip(), 0.5f); 
    }
    
    public void PlayCollectGetSound() 
    {
        audioSource.PlayOneShot
        (collectGetAudioClips.GetAudioClip(), 0.5f);
    }
   
    public void PlayCollectRespawnSound() 
    {
       audioSource.PlayOneShot
       (collectRespawnAudioClips.GetAudioClip(), 0.5f); 
    }
    public void PlayDeathSound() 
    {
        audioSource.PlayOneShot
        (deathAudioClips.GetAudioClip(), 0.5f);
    }
    public void PlayFinishSound() 
    {
        audioSource.PlayOneShot
        (finishAudioClips.GetAudioClip(), 0.5f);
    }    
}
